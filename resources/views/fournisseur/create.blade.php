    ...
    <div class="row justify-content-center d-flex">
        ...
        <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('fournisseur.store') }}" method="post" id="basicform" data-parsley-validate="">
                        @csrf
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="form-group">
                                    <label for="inputUserName">Nom de l'entreprise</label>
                                    <input id="inputUserName" type="text" name="nom" data-parsley-trigger="change" required="" placeholder="Entrez le nom de l'entreprise" autocomplete="off" class="form-control">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="inputUserName" type="text" name="tel" data-parsley-trigger="change" required="" placeholder="Entrez votre numéro" autocomplete="off" class="form-control">
                                </div>
                                <div class="form-group">
